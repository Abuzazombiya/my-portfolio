...
export default function About() {
  return (
    <section id="about" className="relative min-h-screen bg-black flex flex-col items-center justify-center text-gray-100 font-serif transition-colors" data-aos="fade-right">
